package uli.nick.vasiljev.Ch04ControlInstructions.L01UsingIfApplication;
...
public class UsingIfDemo {
    ...
    public static void main(String[] args) {
        ...
        int number;
        ImageIcon img;
        input = JOptionPane.showInputDialog(null, "Введите число", "Проверка числа", JOptionPane.QUESTION_MESSAGE);
        if (input == null) {
