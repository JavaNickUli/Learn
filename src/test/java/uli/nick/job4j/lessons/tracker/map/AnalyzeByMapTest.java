...
class AnalyzeByMapTest {
    ...
    public void whenAverageScore() {
        ...
        then(average).isCloseTo(74.44, offset(0.01D));
    }
    ...
    public void whenListOfPupilAverage() {
        ...
        then(average).hasSameElementsAs(List.of(
    ...
    public void whenBestPupil() {
        ...
        then(best).isEqualTo(new Label("Ivanov", 240D));
    }
    ...
    public void whenBestSubject() {
        ...
        then(best).isEqualTo(new Label("Math", 250D));
    }
}